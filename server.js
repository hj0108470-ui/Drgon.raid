...
const WEAPON_DB = {
    ...
    // 유물(Artifacts) 데이터 추가
    artifact_sun: { name: '태양의 성배', type: 'artifact', rarity: 'Mythic', atk: 1500, sellPrice: 50000, icon: '🏆🔥' },
    artifact_moon: { name: '달빛의 눈물', type: 'artifact', rarity: 'Mythic', atk: 1500, sellPrice: 50000, icon: '💎🌙' }
};
